...
import { FaFacebookF, FaGit, FaTiktok, FaTwitter } from 'react-icons/fa'
                ...
                <div className="text-right">
                    <div className="w-full flex justify-end">
                        <div className="w-full md:w-[300px] py-4 relative">
                            ...
                            <div className="py-4">
                                <form>
                                    <input className="bg-primary border border-input p-2 w-full shadow-xl rounded-2xl md:w-auto outline-none" type="email" placeholder="Enter Your email" />
                                    <button className="bg-button text-btnText px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2 ml-2">Sign Up</button>
                                </form>
                            </div>
